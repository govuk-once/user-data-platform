...
export interface Tags {
  Product: 'user_data_platform';
  Service: 'udp';
  Component: 'user_data' | 'identity_exchange';
  Environment:
    | GovUkOnceEnvironments.Dev
    | GovUkOnceEnvironments.Stag
    | GovUkOnceEnvironments.Prod;
  Owner: 'udp';
  Source: 'https://github.com/govuk-once/user-data-platform';
}

/**
 * Tags
 */
export class TagsAspect implements IAspect {
